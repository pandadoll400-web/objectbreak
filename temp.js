        ...
        function submitCode() {
            ...
            if (codeInput === "20130903") {
                ...
                updateUI();
                saveGame();
                showSystemMessage("🎂 한정판 [생일 케이크] 획득!", "#1abc9c");
